...
/* Map 인터페이스를 이용하여 객체를 만들수는 업지만 (new를 통해서)
 ...
 * 매개변수 : 스캐너, map => Scanner scan, Map<String, String> map (Map으로 사용할경우 tree와 hash 모두 사용가능 )
 * 리턴타입 : 없음
 * 메소드명 : inputInfo
 */
...
/* 기능 : 스캐너를 이용하여  id를 입력받아 map에 해당 id와 일치하는 id가 있는지 확인하여
 * 		있으면 id와 비밀번호를 출력하고, 없으면 없다고 출력하는 메소드
 * 매개변수 : 스캐너 맵 => Scanner scan, Map<String, String> map
 * 리턴타입 : void//따로 반환하지않고 입력을 받는 것이기에 타입이 없음
 * 메소드명 : searchInfo */
...
/* 기능 : 스캐너를 이용하여  id를 입력받고 , map에서 id와 일치하는 정보가 있으면 
 * 		비밀번호를 입력받아 수정하는 메소드
 * 매개변수 : 스캐너 맵 => Scanner scan, Map<String, String> map
 * 리턴타입 : 없음
 * 메소드명 : modifyInfo */
